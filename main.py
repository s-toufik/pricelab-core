...
from pricelab_core.application.use_case.analyse_candles import AnalyseCandles
from pricelab_core.application.use_case.analyse_quotes import AnalyseQuotes

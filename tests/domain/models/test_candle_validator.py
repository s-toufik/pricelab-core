...
from tests.domain.models.candles_generator import (
    candles_strategy,
    invalid_candles_strategy,
    InvalidCandleReason,
)
...
class TestCandleValidator:
    ...
    @given(
        candles=invalid_candles_strategy(
            min_size=1, max_size=10, reason=InvalidCandleReason.NEGATIVE_VOLUME
        )
    )
